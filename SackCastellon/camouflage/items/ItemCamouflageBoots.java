...
public class ItemCamouflageBoots extends ItemArmor
{
...
//	private int biomeColor;
	...
	public ItemCamouflageBoots(int id, EnumArmorMaterial material, int renderID)
	{
		super(id, material, renderID, 3);
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type)
	{
		...
		if(entity instanceof EntityPlayer)
		{
			...
			{
				return "camouflage:textures/models/armor/" + this.getUnlocalizedName().substring(5).replace("_helmet", "").replace("_chestplate", "").replace("_leggings", "").replace("_boots", "") + "_armor_3.png";
			}
		}
